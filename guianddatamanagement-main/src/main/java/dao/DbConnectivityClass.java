...
public class DbConnectivityClass {
    ...
    final static String DB_URL = "jdbc:mysql://csc311lins13.mysql.database.azure.com/CSC311_BD_TEMP";//update this database name
    ...
    public void deleteRecord(Person person) {
        ...
        try {
            ...
            int row = preparedStatement.executeUpdate();
            if (row > 0) {
                MyLogger.makeLog("User was deleted successfully.");
            }
            preparedStatement.close();
            conn.close();
        } catch (SQLException e) {
